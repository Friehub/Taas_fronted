...
export default function DocsPage() {
    ...
    const sections = [
        { id: 'overview', title: 'Protocol Overview', icon: Book },
        { id: 'custom-data', title: 'Custom Data Feeds', icon: Cpu },
        { id: 'sentinel', title: 'Sentinel Setup', icon: Terminal },
        { id: 'challenger', title: 'Challenger Guide', icon: ShieldAlert },
        { id: 'staking', title: 'Staking & $T$ Token', icon: Coins },
    ];

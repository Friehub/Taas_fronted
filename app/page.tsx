...
import { OutcomeDisplay } from '@/components/OutcomeDisplay'; // Existing component
...
export default function DashboardPage() {
    ...
    const statCards = [
        ...
        },
        {
            ...
            icon: Clock,
            trend: -5.2, // Negative is good for latency
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                {/* Sidebar Widgets (Network Health / Faucet Promo) */}

            ...
            <section className="pt-32 pb-40 px-6 overflow-hidden relative">
                ...
                <div className="container mx-auto text-center relative z-10">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-6">
                        <Link href="/overview" className="w-full md:w-auto px-8 py-4 bg-yellow-500 text-black rounded-xl font-extrabold text-lg flex items-center justify-center gap-2 hover:scale-105 transition-all shadow-[0_0_40px_rgba(234,179,8,0.3)]">

            ...
            <div className="h-16 flex items-center px-6 border-b border-border">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div className="text-[10px] font-bold text-primary uppercase tracking-widest">TaaS + Markets</div>
                    </div>
                </div>
            </div>
    ...
    return (
        <header className="h-16 border-b border-border bg-background/80 backdrop-blur-sm sticky top-0 z-10 px-8 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
                ...
                <h1 className="font-bold text-foreground tracking-wide text-sm uppercase">Overview</h1>
            </div>
            ...
            <div className="flex items-center gap-4">
                ...
                {isConnected && (
                    <button className="flex items-center gap-2 px-3 py-1.5 text-[10px] font-bold uppercase tracking-wide text-slate-500 hover:text-white transition-colors border border-transparent hover:border-white/10 rounded-lg">
                        <Zap size={12} />
                        Quick Actions
                    </button>
                )}
                ...
                {isConnected ? (
                    ...
                    <button
                        ...
                        className="px-4 py-1.5 bg-primary hover:bg-primary/90 text-primary-foreground text-xs font-bold uppercase tracking-widest rounded-lg transition-all"
                    >
                        Connect Wallet
                    </button>
                )}

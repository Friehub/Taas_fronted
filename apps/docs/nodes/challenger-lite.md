# Challenger Lite Node

**Verify truth proposals and earn rewards for catching errors**

Challenger Lite nodes re-execute every proposal to verify correctness. When you find an incorrect proposal, submit a dispute and earn the proposer's bond (100 TAAS profit).

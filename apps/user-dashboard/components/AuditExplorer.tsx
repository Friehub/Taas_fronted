            ...
            <div className="glass-premium p-10 rounded-[48px] border border-white/10 relative overflow-hidden group">
                ...
                <div className="relative flex flex-col lg:flex-row lg:items-center justify-between gap-10">
                    <div className="space-y-3">
                        ...
                        <p className="text-xs text-white/30 max-w-sm font-medium leading-relaxed">Cryptographic proof-of-pedigree for FTS network proposals. Instant verification for any data resolution.</p>
                    </div>

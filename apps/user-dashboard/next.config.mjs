        ...
        return [
            {
                ...
                headers: [
                    ...
                    { key: 'Referrer-Policy', value: 'origin-when-cross-origin' },
                    {
                        ...
                        value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://pbs.twimg.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https://pbs.twimg.com https://abs.twimg.com https://grainy-gradients.vercel.app; font-src 'self' https://fonts.gstatic.com; connect-src 'self' https://taas.friehub.cloud https://api.friehub.cloud https://gateway.friehub.cloud https://testnet1.helioschainlabs.org https://grainy-gradients.vercel.app https://*.walletconnect.com https://*.walletconnect.org;",
                    },
                ],
            },
        ];
